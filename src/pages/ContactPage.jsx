...
export default function ContactPage() {
  ...
  return (
    <div ref={containerRef} className="pt-24 pb-16 px-[6vw] bg-[#ffffff] min-h-screen text-[#0f172a] sm:pt-20">
      <div className="grid grid-cols-[1fr_1.2fr] gap-20 items-start max-w-[1400px] mx-auto sm:grid-cols-1 sm:gap-12">
        {/* Left col */}
        <div className="contact-page-left">
          <p className="contact-label font-sans text-[0.70rem] tracking-[0.3em] uppercase text-[#666] mb-6 font-bold">(Get in touch)</p>
